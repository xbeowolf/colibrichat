...
#include "grain-v1sbox.h"


#ifdef __cplusplus
#define ECRYPTNC ecrypt::grainv1::
using namespace ecrypt::grainv1;
#else
#define ECRYPTNC
#endif

const char* ECRYPTNC ECRYPT_NAME = "Grain-v1";           /* [edit] */ 
