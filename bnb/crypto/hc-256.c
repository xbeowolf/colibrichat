...
#ifdef __cplusplus
#define ECRYPTNC ecrypt::hc256::
using namespace ecrypt::hc256;
#else
#define ECRYPTNC
#endif

const char* ECRYPTNC ECRYPT_NAME = "HC-256";           /* [edit] */ 
...
void ECRYPTNC generate_keystream(ECRYPT_ctx* ctx, u32* keystream)
{
	u32 cc,dd;
...
void ECRYPTNC setup_update(ECRYPT_ctx* ctx)  /*each time 16 steps*/
{
	u32 cc,dd;
	cc = ctx->counter2048 & 0x3ff;
	dd = (cc+16)&0x3ff;
