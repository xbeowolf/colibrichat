...
#ifndef ECRYPT_SYNC_LEX
#define ECRYPT_SYNC_LEX
...
__inline int ECRYPT_KEYSIZE(int i) {return (128 + (i)*64);}    /* [edit] */

const int ECRYPT_MAXIVSIZE = 128;                              /* [edit] */
__inline int ECRYPT_IVSIZE(int i) {return (128 + (i)*64);}     /* [edit] */
...
const int ECRYPT_BLOCKLENGTH = 40;            /* [edit] */
