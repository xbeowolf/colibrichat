...
#ifdef __cplusplus
#define ECRYPTNC ecrypt::salsa20::
using namespace ecrypt::salsa20;
#else
#define ECRYPTNC
#endif

const char* ECRYPTNC ECRYPT_NAME = "Salsa20";           /* [edit] */ 
...
void ECRYPTNC ECRYPT_keysetup(ECRYPT_ctx *x,const u8 *k,u32 kbits,u32 ivbits)
{
...
void ECRYPTNC ECRYPT_ivsetup(ECRYPT_ctx *x,const u8 *iv)
{
...
void ECRYPTNC ECRYPT_encrypt_bytes(ECRYPT_ctx *x,const u8 *m,u8 *c,u32 bytes)
{
  u8 output[64];
  u32 i;
...
void ECRYPTNC ECRYPT_decrypt_bytes(ECRYPT_ctx *x,const u8 *c,u8 *m,u32 bytes)
{
