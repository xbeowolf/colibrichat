...
#define ASSERTLUASTR(pos) if (!lua_isstring(L, pos)) {return luaL_error(L, "string expected as an %d argument", pos);}
#define ASSERTLUABOOL(pos) if (!lua_isboolean(L, pos)) {return luaL_error(L, "boolean expected as an %d argument", pos);}
#define ASSERTLUAFUNC(pos) if (!lua_isfunction(L, pos)) {return luaL_error(L, "function expected as an %d argument", pos);}
#define ASSERTLUATABLE(pos) if (!lua_istable(L, pos)) {return luaL_error(L, "table expected as an %d argument", pos);}
#define ASSERTLUADATA(pos) if (!lua_isuserdata(L, pos)) {return luaL_error(L, "userdata expected as an %d argument", pos);}
#define ASSERTLUACO(pos) if (!lua_isthread(L, pos)) {return luaL_error(L, "thread expected as an %d argument", pos);}
#define ASSERTLUA(cond, msg) if (!(cond)) {return luaL_error(L, msg);}
#else
#define ASSERTLUAINT(pos)
#define ASSERTLUANUM(pos)
#define ASSERTLUASTR(pos)
#define ASSERTLUABOOL(pos)
#define ASSERTLUAFUNC(pos)
#define ASSERTLUATABLE(pos)
#define ASSERTLUADATA(pos)
#define ASSERTLUACO(pos)
#define ASSERTLUA(cond, msg)
#endif
